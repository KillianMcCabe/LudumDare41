...
public class TowerInfo : MonoBehaviour
{
    ...
    [SerializeField]
    private TowerInfoStat _statsInfoPrefab = null;

    [SerializeField]
    private StatData[] _statDatas = null;

    private Dictionary<StatData, TowerInfoStat> _statInteractables = new Dictionary<StatData, TowerInfoStat>();
    private Tower _turret = null;

    private void Awake()
    {
        foreach (StatData stat in _statDatas)
        {
            TowerInfoStat statInteractable = Instantiate(_statsInfoPrefab, _statsInfoHolderTransform);
    ...
    public void DisplayInfoForTurret(Tower turret)
    {
        if (_turret == turret)
        {
            return;
    ...
    private void UpdateView()
    {
        ...
        {
            TowerInfoStat statInteractable = _statInteractables[stat];
